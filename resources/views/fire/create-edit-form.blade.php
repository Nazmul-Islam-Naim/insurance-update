              ...
              <div class="card-body">
                ...
                <div class="row gutters">
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="field-wrapper">
                      <div class="input-group">
                        <input type="text" name="used_as" class="form-control @error('used_as') is-invalid @enderror" value="{{old('used_as')}}">
                      </div>
                      <div class="field-placeholder">Used As</div>
                    </div>
                    <!-- Field wrapper end -->
                  </div>
                  <!--------------------------- situation --------------------->
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="field-wrapper">
                      <div class="input-group">
                        <textarea name="situation" class="form-control @error('situation') is-invalid @enderror" style="height: 40px" autocomplete="off">
                          {{(!empty($single_data->situation))?$single_data->situation: old('situation')}}
                        </textarea>
                      </div>
                      <div class="field-placeholder">Situation</div>
                    </div>
                    <!-- Field wrapper end -->
                  </div>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="field-wrapper">
                      <div class="input-group">
                        <textarea  name="construction_premises" class="form-control @error('construction_premises') is-invalid @enderror" style="height: 40px" autocomplete="off">
                          {{(!empty($single_data->construction_premises))?$single_data->construction_premises: old('construction_premises')}}
                        </textarea>
                      </div>
                      <div class="field-placeholder">Construction Premises</div>
                    </div>
                    <!-- Field wrapper end -->
                  </div>
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="table-responsive">
                      ...
                      <table id="myTableID" class="table ">
                        ...
                        <tfoot>
                          <tr>
                            <td style="border: 1px solid #fff; text-align:right; font-weight:bold">
                              Total Amount: 
                            </td>
...
$(document).ready(function () {
  ...
  $("#extra_percent").keyup(function (e) { 
    ...
    var convert = 0;
   //------------------------- parse float ------------//
    var productTotal = parseFloat($("#product_total").val());
    ...
    //------------------------- check extra percent -----------------//
    if (extraPercent > 0) {
      extraAmount = (productTotal * extraPercent)/100;
      totalAmount = productTotal + extraAmount;
    } else {
      extraAmount =  0;
      totalAmount = productTotal + extraAmount;
    }
    ...
    $("#amount_in_bdt").val(Math.round(totalAmount));
    $("#total_premium").val(Math.round(totalAmount));
    $("#net_premium").val(Math.round(totalAmount));
