  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Fire Insurance. Collect Insurance Bill Form Here.</div>
...
<script>
   ...
   function dateFormat(data) { 
    ...
    function filter_view(start_date = '',end_date = '') {
      ...
      deferRender : true,
      ajax:{
        url:  "{{route('fire-bill-collection')}}",
      ...
      dom: 'Blfrtip',
			...
			columns: [
        {
          ...
          data: 'account_info_fire_insurance.grand_total',
				...
				{
          data: 'account_info_fire_insurance.collected_amount',
        },
				{
          data: 'account_info_fire_insurance.due',
        },
				{
          data: 'action',
        },
