...
@section('title', 'Motor Bill Collection')
@section('content')
...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        {!! Form::open(array('route' =>['motor-bill-collection-form-store'],'method'=>'POST','files'=>true)) !!}
        <div class="card">
          <div class="card-header">
            <div class="card-title">Motor Bill Collection</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    value="{{(!empty($single_data->accountInfoMotorInsurance))?$single_data->accountInfoMotorInsurance->grand_total :old('grand_total')}}"  readonly="" autocomplete="off">
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="field-wrapper">
                  <div class="input-group">
                    ...
                    value="{{(!empty($single_data->accountInfoMotorInsurance))?$single_data->accountInfoMotorInsurance->due :old('due')}}"  readonly="" autocomplete="off">
                  </div>
          ...
          <div class="card-footer text-end">
            <a href="{{route('motor-bill-collection')}}" class="btn  btn-warning">Back</a>
