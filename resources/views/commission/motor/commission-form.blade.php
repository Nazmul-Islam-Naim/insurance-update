...
<div class="content-wrapper-scroll">
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        {!! Form::open(array('route' =>['motor-commission.store'],'method'=>'POST','files'=>true, 'onsubmit' => 'return checkTotal()')) !!}
        <div class="card">
          <div class="card-header">
            <div class="card-title">Motor Insurance Commission Distribution</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              <!---------------- Motor commission card-------------------------->
            <div class="card">
              <div class="card-header">
                <div class="card-title"> 
                  Client Name: {{$single_data->client->name}} || Client Phone: {{$single_data->client->phone}} || Address: {{$single_data->client->address}} || Sum of Insured: {{$single_data->accountInfoMotorInsurance->grand_total}} TK.
                </div>
              </div>
              <div class="card-body">
                <div class="row ">
                ...
                <div class="row gutters">
                  <input type="hidden" name="grand_total" id="grand_total" value="{{$single_data->accountInfoMotorInsurance->grand_total}}">
          ...
          <div class="card-footer text-end">
            <a href="{{route('motor-commission.index')}}" class="btn  btn-warning">Back</a>
