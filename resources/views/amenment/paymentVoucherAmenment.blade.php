...
@section('title', 'Income Voucher Report')
@section('content')
    ...
    <div class="row gutters">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form method="post" action="{{ route('other-payment.filter') }}">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">{{ __('menu.payment_voucher_report') }}</h3>
          ...
          <div class="card-body">
            <div class="col-md-12" id="printTable">
              <center><h5 style="margin: 0px">{{ __('menu.payment_voucher_report') }}</h5></center>
                ...
                <table class="" style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0">  
                  <thead> 
                    ...
                    <tr> 
                      ...
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Payment Method</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Type</th>
                      <th style="border: 1px solid #ddd; padding: 3px 3px; color: #000">Issue By</th>
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{date('d-m-Y',strtotime($data->payment_date))}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->otherpayment_bank_object->bank_name}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->otherpayment_type_object->name}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000">{{$data->issue_by}}</td>
                    ...
                    @if($rowCount==0)
                      <tr>
                        <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000" colspan="7" align="center">
                  ...
                  <tfoot> 
                    <tr> 
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000; text-align: center" colspan="5"><b>Total</b></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000"><b>{{number_format($sum, 2)}}</b></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; color: #000"></td>
                    </tr>
                  </tfoot>
                </table>
