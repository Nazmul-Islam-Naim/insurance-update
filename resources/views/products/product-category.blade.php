    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['product-category.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Edit";?>
        @else
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions" style="height: 25px">
                        <a href="{{ route('product-category.edit', $data->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['product-category.destroy',$data->id],'method'=>'DELETE'))}}
