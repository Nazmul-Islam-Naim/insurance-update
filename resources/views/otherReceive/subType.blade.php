  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">{{ __('menu.add_other_income_sub_type') }}</h3>
          </div>
          <!-- /.card-header -->
          ...
          <div class="card-body">
            <div class="field-wrapper">
              ...
              <div class="field-placeholder">{{ __('home.sub_type_name') }} <span class="text-danger">*</span></div>
            </div>
            <div class="field-wrapper">
              <div class="input-group">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">{{ __('menu.income_sub_type_list') }}</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- Start Modal for edit Income Sub Type -->
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title"><i class="fa fa-edit"></i> {{ __('menu.edit_other_income_sub_type') }}</h4>
                      ...
                      <!-- End Modal for edit Income Sub Type -->
                    </td>
                  </tr>
                  @endforeach
                </tbody>
