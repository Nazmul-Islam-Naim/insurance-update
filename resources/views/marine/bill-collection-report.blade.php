...
@section('title', 'Mrine Bill Collection Report')
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="row gutters">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Marine Bill Collection Report</div>
...
<script>
   ...
   function dateFormat(data) { 
    ...
    function filter_view(start_date = '',end_date = '') {
      ...
      deferRender : true,
			ajax:{
        url:  "{{route('marine-bill-collection-report')}}",
