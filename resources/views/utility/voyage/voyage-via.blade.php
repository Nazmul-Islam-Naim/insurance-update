    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['voyage-via.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Edit";?>
        @else
        {!! Form::open(array('route' =>['voyage-via.store'],'method'=>'POST','files'=>true)) !!}
          <?php $info ="Add";?>
        @endif
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}}  Voyage Via</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Voyage Via List</div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions" style="height: 25px">
                        <a href="{{ route('voyage-via.edit', $data->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['voyage-via.destroy',$data->id],'method'=>'DELETE'))}}
