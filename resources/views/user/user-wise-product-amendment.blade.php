...
@section('title', 'User Wise Product Amendment')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">User Wise Product Amendment</h3>
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   function dateFormat(data) { 
	...
	$(document).ready(function() {
      ...
      var table = $('#example').DataTable({
			...
			processing: true,
      deferRender : true,
			ajax: "{{route('user-wise-product-amendment')}}",
      ...
      dom: 'Blfrtip',
			...
			columns: [
        {
          ...
          data: 'user.name',
				...
				{
          data: 'user.designation.title',
        },
				{
          data: 'user.department.title',
        },
				{
          ...
          render: function(data, type, row) {
            var url = '{{route("user-wise-product-details",":tok")}}'; 
            var url = url.replace(':tok', row.tok);
            return '<a href=' + url +'>Product#'+ row.id +'</a>';
          }
        },
				{
          data: 'note',
    ...
    $("#example").on("click", ".button-delete", function(e) {
        ...
        var id = $(this).data('id');
        var link = '{{route("user-wise-product.destroy",":id")}}';
