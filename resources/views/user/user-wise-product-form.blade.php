...
@section('title', 'User Product Form')
@section('content')
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">User Product Permission Form</div>
                    </div>
                    {!! Form::open(array('route' =>['user-wise-product.store'],'method'=>'POST','files'=>true)) !!}
                    <div class="card-body">
                      <div class="col-md-12">
                          <div class="form-inline">
                            <div class="row">
                              <div class="col-md-4">
                                <div class="field-wrapper">
                                  <div class="input-group">
                                    <select name="user_id" class="form-control select-single js-states select2" required="" data-live-search="true" autocomplete="off">
                              ...
                              <div class="col-md-4">
                                <div class="field-wrapper">
                                  <div class="input-group">
                                    <input class="form-control datepicker" type="text" name="date" value="<?php echo date('Y-m-d');?>" autocomplete="off" required="">
                                  </div>
                            ...
                            <table id="myTableID" class="table table-sm">
                                ...
                                <?php $row_num = 1; ?>
                                    <tr id="row_{{$row_num}}">
                                        ...
                                        <td style="border: 1px solid #fff">
                                            <input type="text" step="any" class="form-control quantity_{{$row_num}}"
...
$(document).ready(function() {
    ...
    $("#addone").on('click', function() {
        ...
        row += '</td>';
        row += '<td>';
        row += ' <input type="text" step="any" class="form-control quantity_' + i +'" name="addmore[' + i +'][quantity]" id="quantity" autocomplete="off">';
        row += '</td>';
        row += '<td>';
