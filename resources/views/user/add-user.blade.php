        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row gutters">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                <div class="field-wrapper">
                  <select class="select-single js-states select2" name="branch_id"   data-live-search="true" required="">
                    <option value="">Select</option>
                    @foreach($allbranch as $brnach)
                    <option value="{{$brnach->id}}" {{(!empty($single_data) && $single_data->branch_id==$brnach->id)?'selected':''}}>{{$brnach->name}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                <div class="field-wrapper">
                  <select class="select-single js-states select2" name="role_id"   data-live-search="true" required="">
                    <option value="">Select</option>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                <div class="field-wrapper">
                  <select class="select-single js-states select2" name="department_id"   data-live-search="true" required="">
                    <option value="">Select</option>
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                <div class="field-wrapper">
                  <select class="select-single js-states select2" name="designation_id"   data-live-search="true" required="">
                    <option value="">Select</option>
