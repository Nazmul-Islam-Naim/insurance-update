...
class BankAccountController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['alldata']= BankAccount::checkBranch()->orderBy('id', 'DESC')->paginate(50);
    ...
    public function showBankReport($id)
    {
        ...
        $data['alldata'] = TransactionReport::where('bank_id', '=', $id)->get();
    ...
    public function showBankReportFilter(Request $request, $id)
    {
        if ($request->start_date !="" && $request->end_date !="") {
            $data['singledata'] = BankAccount::where('id', '=', $id)->first();
            $data['alldata'] = TransactionReport::whereBetween('transaction_date', [dateFormateForDB($request->start_date), dateFormateForDB($request->end_date)])->where('bank_id', $id)->get();
